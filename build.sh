...
mv geolocatefox.jar ../dist/build/chrome/geolocatefox.jar
...
cp install.js ./dist/build/install.js
cd ./dist/build/
zip -6 ./geolocatefox.xpi -r ./chrome/ ./install.rdf ./install.js
mv geolocatefox.xpi ../
cd ../../
