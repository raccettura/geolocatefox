...
var XpiInstaller = {
	...
	extFullName: 'GeoLocateFox', // The name displayed to the user (don't include the version)
	extShortName: 'geolocatefox', // The leafname of the JAR file (without the .jar part)
	extVersion: '0.2',
	extAuthor: 'Robert Accettura',
